...
function initFirstPage(){
			...
			circs= containerMC.addChild(new image(5,46,"assets/screen1_r1_c1.png",true,1,false));
		
           btn1 = containerMC.addChild(new Button("next","", "#F00", "assets/touch_3.png", 800,300,true,3, 125,125));
